...
public class AdminController {
    ...
    public AdminController(CardRepository cardRepository, UserRepository userRepository, DeckRepository deckRepository, LootboxGenerator lootboxGenerator) {
    ...
    public ResponseEntity<Lootbox> generateLootbox(@RequestParam String type) {
        ...
        Lootbox lootbox = lootboxGenerator.generateLootbox(lootboxType);
        return ResponseEntity.status(HttpStatus.CREATED).body(lootbox);
    }
}
